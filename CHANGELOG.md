...
- **Composer:** quick markdown bar (B/I/code/link/☑/H/#) wrapping selection, hashtag autocomplete (type # + overlay of top 8 tags), composer becomes tonal bar with divider
